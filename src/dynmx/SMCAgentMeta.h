...
#ifndef _DMX_SMC_AGENT_META_
#define _DMX_SMC_AGENT_META_
...
//----------------------------------------------------------------------------------------------------------------------
class SMCAgentMeta : public SMCAgentEvo
{
  enum SMCEvalMode
  {
...
//----------------------------------------------------------------------------------------------------------------------
inline void SMCAgentMeta::reset()
{
  SMCAgentEvo::reset();
...
//----------------------------------------------------------------------------------------------------------------------
inline void SMCAgentMeta::nextTrial(int trial)
{
  const std::vector<Positionable*>& objects = m_agent->getEnvironment().getObjects();
...
//----------------------------------------------------------------------------------------------------------------------
inline void SMCAgentMeta::endOfEvaluation(float fitness)
{
}

//----------------------------------------------------------------------------------------------------------------------
inline float SMCAgentMeta::getFitness()
{
...
//----------------------------------------------------------------------------------------------------------------------
inline void SMCAgentMeta::updateFitness()
{
